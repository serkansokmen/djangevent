...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_session', 'creator',
        ...
        # Adding field 'Session.abstract'
        db.add_column(u'events_session', 'abstract',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'events_session', 'creator_id')

        # Deleting field 'Session.level'
        db.delete_column(u'events_session', 'level')

        # Deleting field 'Session.abstract'
        db.delete_column(u'events_session', 'abstract')
