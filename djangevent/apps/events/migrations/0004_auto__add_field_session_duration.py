...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.duration'
        db.add_column(u'events_session', 'duration',
                      self.gf('django.db.models.fields.CharField')(default=u'0 hours', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.duration'
        db.delete_column(u'events_session', 'duration')
