...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.level'
        db.alter_column(u'events_session', 'level', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Session.level'
        db.alter_column(u'events_session', 'level', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
