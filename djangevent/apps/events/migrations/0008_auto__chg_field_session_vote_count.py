...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.vote_count'
        db.alter_column(u'events_session', 'vote_count', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Session.vote_count'
        db.alter_column(u'events_session', 'vote_count', self.gf('django.db.models.fields.PositiveIntegerField')())
