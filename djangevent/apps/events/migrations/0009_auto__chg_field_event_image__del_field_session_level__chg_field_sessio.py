...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'image', self.gf('athumb.fields.ImageWithThumbsField')(max_length=255, null=True))
        # Deleting field 'Session.level'
        db.delete_column(u'events_session', 'level')


        # Changing field 'Session.duration'
        db.alter_column(u'events_session', 'duration', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Event.image'
        db.alter_column(u'events_event', 'image', self.gf('django.db.models.fields.files.ImageField')(default=u'', max_length=100))
        # Adding field 'Session.level'
        db.add_column(u'events_session', 'level',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50),
                      keep_default=False)


        # Changing field 'Session.duration'
        db.alter_column(u'events_session', 'duration', self.gf('django.db.models.fields.CharField')(max_length=50))
